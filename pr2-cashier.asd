(defsystem pr2-cashier
  ...
  ((:module "src"
    ...
    ((:file "package")
     ...
     (:file "side-location" :depends-on ("package"))
     (:file "object-knowledge" :depends-on ("package" ))
     (:file "prolog-queries" :depends-on ("package" ))
     ...
     (:file "pr2-refill-setup" :depends-on ("package" "object-knowledge" "spawn-objects" "scan-objects" "cashier-designator" "cashier-designator-plan"))
     (:file "pr2-kitchen-setup" :depends-on ("package" "object-knowledge" "spawn-objects" "scan-objects" "cashier-designator" "cashier-designator-plan"))))))
